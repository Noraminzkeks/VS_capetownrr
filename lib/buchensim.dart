...
class BuchenSimClass extends StatefulWidget {
  const BuchenSimClass({super.key});

  @override
  State<BuchenSimClass> createState() => _BuchenSimClassState();
}

class _BuchenSimClassState extends State<BuchenSimClass> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
