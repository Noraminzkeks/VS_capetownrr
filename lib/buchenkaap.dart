...
class BuchenKaapClass extends StatefulWidget {
  const BuchenKaapClass({super.key});

  @override
  State<BuchenKaapClass> createState() => _BuchenKaapClassState();
}

class _BuchenKaapClassState extends State<BuchenKaapClass> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                ...
                children: [
                  Text('1.5h',
                      style: TextStyle(
                          ...
                          color: Colors.black54,
                          fontSize: 15)),
                  Text('Meeting Point: Kloof Street',
                      style: TextStyle(
                          fontFamily: 'Roboto',
                          color: Colors.black54,
                          fontSize: 15)),
